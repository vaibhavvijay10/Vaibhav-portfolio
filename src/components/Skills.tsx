...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: ["GA4", "AppsFlyer", "Looker", "Mixpanel", "Looker Studio", "SEMrush", "Ahrefs", "Data Analysis"],
  },
  {
    name: "Growth Stack",
    skills: ["HubSpot", "MoEngage", "Braze", "Customer.io", "Figma", "Jira", "Intercom", "Freshdesk", "Zapier", "Slack"],
  },
  {
    name: "Soft Skills",
    skills: [
